...
LDLIBSOPTIONS=-lavcodec -lavformat -lavutil -lswscale `pkg-config --libs opencv`  
...
${OBJECTDIR}/VideoInterface.o: VideoInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Wall `pkg-config --cflags opencv`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/VideoInterface.o VideoInterface.cpp
