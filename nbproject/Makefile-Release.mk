...
${OBJECTDIR}/GeneralException.o: GeneralException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GeneralException.o GeneralException.cpp

${OBJECTDIR}/OpenVideoException.o: OpenVideoException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OpenVideoException.o OpenVideoException.cpp
